...
export default function TextAnimation({aidssemesters,aimlsemesters}) {
  ...
  return (
    <div className="lg:w-1/2 flex flex-col justify-center items-start space-y-8 p-8">
      ...
      <div className="flex justify-center items-center sm:ml-20 lg:ml-0 w-[80%] sm:w-[70%] lg:w-[80%] h-auto lg:hidden">
        <img
      ...
      <div className="relative flex flex-col items-center lg:items-start ml-12 sm:ml-36 lg:ml-16">
