...
export function SemInfoProvider({ children }) {
  ...
  return (
    <SemInfoContext.Provider value={{openDialog3,setOpenDialog3,openDialog4,setOpenDialog4,openDialog5,setOpenDialog5,editorCardData,setEditorCardData,seminfo, setSeminfo ,openDialog,setOpenDialog,selectedCardData, setSelectedCardData,branchdrop,setBranchdrop,openDialog2, setOpenDialog2,imgsrc,setImgSrc,logindetails,setLoginDetails,isauthenticated,setIsAuthenticated}}>
      {children}
